...
from api.auth_models import AuthResponse, UpdateProfileRequest, UserResponse
...
def update_user_profile(user_id: str, request: UpdateProfileRequest) -> UserResponse:
