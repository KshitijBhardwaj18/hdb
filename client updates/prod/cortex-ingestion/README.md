...
The ingestion service runs a Kafka consumer that listens for document ingestion messages. Check the readiness endpoint
to verify the consumer is running:
