...
This directory contains the configuration for [External Secrets Operator (ESO)](https://external-secrets.io/) to
securely manage secrets for the Cortex platform using AWS Secrets Manager.
...
By default, secrets are refreshed every hour. To change this, edit the `refreshInterval` field in the ExternalSecret
manifests:
