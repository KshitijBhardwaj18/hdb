...
The script uses a custom tag key by default to avoid conflicts with existing Karpenter installations that may use the
standard `karpenter.sh/discovery` tag.
